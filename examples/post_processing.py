...
TEGDET_VARIANTS_RESULTS_PATH = "/script_results/tegdet_variants_results_ref.csv"
TEGDET_PARAMS_SENSITIVITY_RESULTS_PATH = "/script_results/tegdet_params_sensitivity_results_ref.csv"
